...
Author: Manroop Turna
                ...
                Youtube Keyword Search & Audio/video Clipping

        After downloading the youtube audio/video/caption files.
        This code perform the Keyword Search from captions and cut the
        correpsonding audio.
        Files must be downloaded using "youtube-dl" package.
        Syntax given below:
        --------##youtube-dl --all-subs -f 140 -a "Link"--------------
        Sort audio and subttile files into different folders before running the code.

        File Path must be changed if location is changed.
        Also, the length of string slice must be changed after path change.
"""
...
"""
    Here Time Data is written as a Sting.
    It must be converted into integer before
    processing audio.
